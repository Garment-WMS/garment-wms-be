...
export class MaterialExportRequestDetailService {
  create(createMaterialExportRequestDetailDto: CreateMaterialExportRequestDetailDto) {
  ...
  update(id: number, updateMaterialExportRequestDetailDto: UpdateMaterialExportRequestDetailDto) {
