/*
  ...
  - The values [DISCARDED] on the enum `MaterialReceiptStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "MaterialReceiptStatus_new" AS ENUM ('IMPORTING', 'AVAILABLE', 'USED', 'DISPOSED');
