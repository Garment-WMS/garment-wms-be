/*
  ...
  - The values [IMPORTING,IMPORTED] on the enum `import_request_status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "import_request_status_new" AS ENUM ('ARRIVED', 'INSPECTING', 'INSPECTED', 'CANCELED', 'PENDING', 'REJECTED', 'APPROVED');
