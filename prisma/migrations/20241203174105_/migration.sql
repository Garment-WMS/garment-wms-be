/*
  ...
  - The values [EXECUTING] on the enum `production_batch_status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "production_batch_status_new" AS ENUM ('PENDING', 'WAITING_FOR_EXPORTING_MATERIAL', 'MANUFACTURING', 'IMPORTING', 'FINISHED', 'CANCELED');
